...
class VideoPlayerAdapter(val requestManager: RequestManager) : RecyclerView.Adapter<VideoPlayerViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VideoPlayerViewHolder {
          val view = LayoutInflater.from(parent.context).inflate(R.layout.video_list_item2,parent,false)
